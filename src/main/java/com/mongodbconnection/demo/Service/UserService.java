...
//            if(cognitiveServiceMediaStatus != null && cognitiveServiceMediaStatus.getStatus()!=null && cognitiveServiceMediaStatus.getStatus().equals("you cannot view this resource")){
//                return cognitiveServiceMediaStatus;
//            }



//        CognitiveServiceMediaStatus tempMediaStatus=cognitiveServiceRepository.findOne(userId);
//        if (tempMediaStatus.getStatus().contentEquals("Done")){
//            System.out.println("if statment");
//            return tempMediaStatus;
//        }else {
//            asyncService.getUserAccesTokenFromId(userId,userRequestId,url,list,cognitiveServiceMediaStatus);
//            tempMediaStatus.setStatus("Updating");
//            cognitiveServiceRepository.save(tempMediaStatus);
//            System.out.println("else statment");
//            return cognitiveServiceMediaStatus;
//               //status update veya done olarak gonder
//        }
...
//burada söyle bir sıkıntı ılk dongude else kısmına gırıyor ve updatıng yapıyor
//bu yuzden response da updatıng kalıyor
//ama bıze you cannot view this resource cevabnın getırmesı lazım
//            if (cognitiveServiceMediaStatus != null && cognitiveServiceMediaStatus.getStatus().equals("Updating")) {
//                if (count == 0) {
//                    asyncService.getUserAccesTokenFromId(userId, userRequestId, null, null, null);
//                }
//                count++;
//                if (cognitiveServiceMediaStatus.getStatus().equals("Done")) {
//                    return cognitiveServiceMediaStatus;
//                }
//                // asyncService.getUserAccesTokenFromId(userId,userRequestId,null,null,null);
//            }
//  asyncService.getUserAccesTokenFromId(userId,userRequestId,null,null,null);
//cognitiveServiceMediaStatus.setId("asdas");
//cognitiveServiceMediaStatus.setMaxHappinesValueUrl("asdsad");
//            return cognitiveServiceMediaStatus;
//veri tabanına gidecek kontrol edecek done
//veri tabanındann veriyi cekecek gondereck
